...
public class DateTimePickerFragment extends DialogFragment implements DatePickerDialog.OnDateSetListener,
  ...
  public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
    ...
    if(mode == Mode.DATE){
      dialog = new DatePickerDialog(getActivity(), this, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH));
    }else{
      dialog = new TimePickerDialog(getActivity(), this, calendar.get(Calendar.HOUR_OF_DAY), calendar.get(Calendar.MINUTE),
